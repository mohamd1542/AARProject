...
public class UpdateUserRpointTemplateCommand : IRequest<Unit>, IMapFrom<UserRpointTemplate>
{
    ...
    {
        profile.CreateMap<UpdateUserRpointTemplateCommand, UserRpointTemplate>();
    }
}
