    ...
    public partial class Init_UserRequestTemplate_Fix : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleSource", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoleSource_Roles",
                        column: x => x.RoleId,
                        principalTable: "Role",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PointTemplate", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PointTemplate_Points",
                        column: x => x.PointId,
                        principalTable: "Point",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PointTemplate_Template",
                        column: x => x.TemplateId,
                        principalTable: "Template",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRequestTemplate", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRPointTemplates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserRPointTemplates_PointTemplate",
                        column: x => x.PointTemplateId,
                        principalTable: "PointTemplate",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comment_UserRPointTemplateId",
                table: "Comment",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PointTemplate_TemplateId",
                table: "PointTemplate",
                column: "TemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleSource_RoleId",
                table: "RoleSource",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleSource_SourceId",
                table: "RoleSource",
                column: "SourceId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleTemplate_RoleId",
                table: "RoleTemplate",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleTemplate_TemplateId",
                table: "RoleTemplate",
                column: "TemplateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRequestTemplate_SourceId",
                table: "UserRequestTemplate",
                column: "SourceId");

            migrationBuilder.CreateIndex(
                name: "IX_UserRequestTemplate_TemplateId",
                table: "UserRequestTemplate",
                column: "TemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_UserRequestTemplate_UserId",
                table: "UserRequestTemplate",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRPointTemplates_PointTemplateId",
                table: "UserRPointTemplates",
                column: "PointTemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_UserRPointTemplates_UserRequestTemplateId",
                table: "UserRPointTemplates",
                column: "UserRequestTemplateId");
        }
